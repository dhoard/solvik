...
| Runtime type introspection (`typeOf`, `isType`) | reference | complete | complete | Top-level built-ins; case-sensitive canonical type names |
...
| Process args | reference | complete | complete | `args()` |
...
structs, enums, exceptions, traits, package loading, static validation,
threads/mutexes/processes, and standard namespaces. The Rust binary has no embedded
