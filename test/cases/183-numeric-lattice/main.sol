...
struct Main {
    public static func run(args: String...): Long {
        ...
        let l2: Long = i
        System.getOut().println(l2)

        // Binary promotion: Integer + Long -> Long.
        System.getOut().println(i + l)
        // Byte + Short -> Integer.
        System.getOut().println(b + s)
        // Integer + Float -> Float.
        System.getOut().println(1 + f)
        // Long + Double -> Double.
        System.getOut().println(l + d)
        // Cross-kind numeric comparison promotes.
        if 2 == 2.0 { System.getOut().println("eq") }
        if 1 < 1.5 { System.getOut().println("lt") }
        // Checked integer arithmetic stays in the promoted width, then
        // widens into Long.
        let small: Integer = Integer.MAX_VALUE - 1
        let wide: Long = small + 1
        System.getOut().println(wide)
        return 0
    }
}
